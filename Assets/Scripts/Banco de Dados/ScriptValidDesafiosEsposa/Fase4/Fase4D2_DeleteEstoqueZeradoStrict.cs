...
public class Fase4D2_DeleteEstoqueZeradoStrict : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        furniture.validator = new Func<string, int, DatabaseManager, bool>(ValidateDeleteEstoqueZerado_AnyOrderWhere);
    }

    private bool ValidateDeleteEstoqueZerado_AnyOrderWhere(string sql, int _, DatabaseManager __)
    {
        ...
        return hasTipoEstoque && hasQtdLeZero;
    }
